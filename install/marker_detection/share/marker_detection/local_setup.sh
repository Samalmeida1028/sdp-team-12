...
: ${AMENT_CURRENT_PREFIX:="/mnt/e/UMass_Amherst/SDP/sdp-team-12/install/marker_detection"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/marker_detection/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/marker_detection/environment/path.sh"
